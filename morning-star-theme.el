...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   ;; Mode Line
   `(mode-line                  ((,class (:background ,bg2 :foreground ,green1))))
   `(mode-line-highlight        ((,class (:underline t))))
   `(mode-line-emphasis         ((,class (:bolt t))))
   `(mode-line-inactive         ((,class (:background ,bg2     :foreground ,green1))))
   `(powerline-active1          ((,class (:background ,grey1   :foreground ,purple1))))
   `(powerline-active2          ((,class (:background ,bg2     :foreground ,black1))))
   `(powerline-inactive1        ((,class (:background ,grey1   :foreground ,purple1))))
   `(powerline-inactive2        ((,class (:background ,bg2     :foreground ,purple1))))
   ...
   `(spaceline-flycheck-warning ((,class (:foreground ,yellow2))))
   `(spaceline-flycheck-info    ((,class (:foreground ,green2))))
   ...
   `(diredp-deletion-file-name     ((,class (:foreground ,black1  :background ,red1     :box (:style released-button :color ,black2)))))
   `(diredp-deletion               ((,class (:foreground ,black1  :background ,red1     :box (:style released-button :color ,black2)))))
   `(diredp-flag-mark-line         ((,class (:foreground ,black1  :background ,purple1  :box (:style released-button :color ,black2)))))
   `(diredp-flag-mark              ((,class (:foreground ,red3    :background ,purple1  :box (:style released-button :color ,black2) :bold t))))
