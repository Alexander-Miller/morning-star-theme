...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(magit-branch-current              ((,class (:background ,bg :foreground ,blue3   :box (:color ,black2 :line-width 2 :style released-button)))))
   `(magit-branch-local                ((,class (:background ,bg :foreground ,orange1 :box (:color ,black2 :line-width 2 :style released-button)))))
   `(magit-branch-remote               ((,class (:background ,bg :foreground ,green1  :box (:color ,black2 :line-width 2 :style released-button)))))
