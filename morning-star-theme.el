...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   ;; Rainbow Delimiters
   `(rainbow-delimiters-depth-1-face    ((,class :foreground ,blue1   :bold t)))
   `(rainbow-delimiters-depth-2-face    ((,class :foreground ,red1    :bold t)))
   `(rainbow-delimiters-depth-3-face    ((,class :foreground ,yellow1 :bold t)))
   `(rainbow-delimiters-depth-4-face    ((,class :foreground ,green1  :bold t)))
   `(rainbow-delimiters-depth-5-face    ((,class :foreground ,purple1 :bold t)))
   `(rainbow-delimiters-depth-6-face    ((,class :foreground ,orange1 :bold t)))
   `(rainbow-delimiters-depth-7-face    ((,class :foreground ,aqua1   :bold t)))
   `(rainbow-delimiters-depth-8-face    ((,class :foreground ,orange2 :bold t)))
