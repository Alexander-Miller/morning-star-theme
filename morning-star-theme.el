...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(magit-branch-current              ((,class (:background ,bg :foreground ,blue3   :bold t :box (:color ,grey2 :line-width 1)))))
   `(magit-branch-local                ((,class (:background ,bg :foreground ,orange1 :bold t :box (:color ,grey2 :line-width 1)))))
   `(magit-branch-remote               ((,class (:background ,bg :foreground ,green1  :bold t :box (:color ,grey2 :line-width 1)))))
