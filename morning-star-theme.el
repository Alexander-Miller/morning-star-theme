...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(diredp-dir-priv               ((,class (:foreground ,black1  :background ,blue1    :box ,black1))))
   `(diredp-file-name              ((,class (:foreground ,black1  :background ,orange2  :box ,black1))))
   `(diredp-file-suffix            ((,class (:foreground ,black1  :background ,orange2  :box ,black1))))
   `(diredp-symlink                ((,class (:foreground ,black1  :background ,aqua1    :box ,black1))))
   `(diredp-ignored-file-name      ((,class (:foreground ,black1  :background ,grey2    :box ,black1))))
   `(diredp-compressed-file-suffix ((,class (:foreground ,black1  :background ,purple2  :box ,black1))))
   `(diredp-deletion-file-name     ((,class (:foreground ,fg      :background ,red3     :box ,black1))))
   `(diredp-deletion               ((,class (:foreground ,yellow2 :background ,red3     :box ,black1 :bold nil))))
   ...
   `(helm-selection          ((,class (:background ,bg2 :box nil :underline ,red1 :overline ,red1 :bold nil))))
   ...
   `(magit-section-title              ((,class (:foreground ,purple1 :underline t :height 1.1))))
