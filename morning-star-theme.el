...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   ;; Mode Line
   `(mode-line                  ((,class (:box ,black1 :background ,bg2 :foreground ,green1))))
   `(mode-line-highlight        ((,class (:box ,black1 :underline t))))
   `(mode-line-emphasis         ((,class (:box ,black1 :bolt t))))
   `(mode-line-inactive         ((,class (:box ,black1 :background ,bg2     :foreground ,green1))))
   `(powerline-active1          ((,class (:box ,black1 :background ,grey1   :foreground ,purple1))))
   `(powerline-active2          ((,class (:box ,black1 :background ,bg2     :foreground ,black1))))
   `(powerline-inactive1        ((,class (:box ,black1 :background ,grey1   :foreground ,purple1))))
   `(powerline-inactive2        ((,class (:box ,black1 :background ,bg2     :foreground ,purple1))))
   `(spaceline-evil-normal      ((,class (:box ,black1 :background ,red1    :foreground ,black1))))
   `(spaceline-evil-insert      ((,class (:box ,black1 :background ,green2  :foreground ,black1))))
   `(spaceline-evil-visual      ((,class (:box ,black1 :background ,purple2 :foreground ,black1))))
   `(spaceline-evil-emacs       ((,class (:box ,black1 :background ,aqua2   :foreground ,black1))))
   `(spaceline-evil-motion      ((,class (:box ,black1 :background ,orange1 :foreground ,black1))))
   `(spaceline-evil-replace     ((,class (:box ,black1 :background ,aqua2   :foreground ,black1))))
   `(spaceline-flycheck-error   ((,class (:box ,black1 :foreground ,red1))))
   `(spaceline-flycheck-warning ((,class (:box ,black1 :foreground ,yellow2))))
   `(spaceline-flycheck-info    ((,class (:box ,black1 :foreground ,green2))))
   ...
   `(link                       ((,class (:foreground ,blue1  :underline  (:color ,aqua2)))))
   ...
   `(dired-mark                    ((,class (:inherit helm-visible-mark))))
   ...
   `(diredp-dir-name               ((,class (:foreground ,blue1))))
   ...
   `(diredp-deletion-file-name     ((,class (:foreground ,red2 :background ,black2 :box (:color ,grey2 :line-width 1)))))
   `(diredp-deletion               ((,class (:foreground ,red2 :background ,black2 :box (:color ,grey2 :line-width 1)))))
   `(diredp-flag-mark-line         ((,class (:inherit helm-visible-mark))))
   `(diredp-flag-mark              ((,class (:inherit helm-visible-mark :foreground ,purple1 :bold t))))
   ...
   `(helm-visible-mark                 ((,class (:background ,black2 :box (:color ,grey2 :line-width 1)))))
   `(helm-source-header                ((,class (:background ,aqua2 :foreground ,black1 :bold nil :box (:color ,black2 :style released-button :line-width 2)))))
   ...
   ;; `(magit-branch-current              ((,class (:foreground ,black1 :background ,red2   :box ,grey2))))
   `(magit-branch-local                ((,class (:foreground ,black1 :background ,blue1  :box (:color ,black2 :style released-button)))))
   `(magit-branch-remote               ((,class (:foreground ,black1 :background ,green1 :box (:color ,black2 :style released-button)))))
   ...
   `(magit-section-heading             ((,class (:foreground ,purple1 :underline t :height 1.1))))
