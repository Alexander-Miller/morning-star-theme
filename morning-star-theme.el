...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(font-lock-function-name-face     ((,class (:foreground ,blue3))))
   ...
   `(rainbow-delimiters-depth-4-face    ((,class :foreground ,blue3)))
   ...
   ;; Helm
   `(helm-ff-directory                 ((,class (:foreground ,blue3))))
   ...
   `(helm-separator                    ((,class (:foreground ,blue3))))
   `(helm-buffer-file                  ((,class (:foreground ,fg))))
   `(helm-buffer-size                  ((,class (:foreground ,green1))))
   `(helm-buffer-directory             ((,class (:foreground ,blue3))))
   ...
   `(helm-time-zone-home     ((,class (:background ,blue3))))
