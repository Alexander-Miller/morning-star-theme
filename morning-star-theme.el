...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   ;; Mode Line
   `(mode-line                  ((,class (:box (:color ,grey2 :line-width 2) :background ,bg2 :foreground ,green1))))
   `(mode-line-highlight        ((,class (:box (:color ,grey2 :line-width 2) :underline t))))
   `(mode-line-emphasis         ((,class (:box (:color ,grey2 :line-width 2) :bolt t))))
   `(mode-line-inactive         ((,class (:box (:color ,grey2 :line-width 2) :background ,bg2     :foreground ,green1))))
   `(powerline-active1          ((,class (:box (:color ,grey2 :line-width 2) :background ,grey1   :foreground ,purple1))))
   `(powerline-active2          ((,class (:box (:color ,grey2 :line-width 2) :background ,bg2     :foreground ,black1))))
   `(powerline-inactive1        ((,class (:box (:color ,grey2 :line-width 2) :background ,grey1   :foreground ,purple1))))
   `(powerline-inactive2        ((,class (:box (:color ,grey2 :line-width 2) :background ,bg2     :foreground ,purple1))))
   `(spaceline-evil-normal      ((,class (:box (:color ,grey2 :line-width 2) :background ,red1    :foreground ,black1))))
   `(spaceline-evil-insert      ((,class (:box (:color ,grey2 :line-width 2) :background ,green2  :foreground ,black1))))
   `(spaceline-evil-visual      ((,class (:box (:color ,grey2 :line-width 2) :background ,purple2 :foreground ,black1))))
   `(spaceline-evil-emacs       ((,class (:box (:color ,grey2 :line-width 2) :background ,aqua2   :foreground ,black1))))
   `(spaceline-evil-motion      ((,class (:box (:color ,grey2 :line-width 2) :background ,orange1 :foreground ,black1))))
   `(spaceline-evil-replace     ((,class (:box (:color ,grey2 :line-width 2) :background ,aqua2   :foreground ,black1))))
   `(spaceline-flycheck-error   ((,class (:box (:color ,grey2 :line-width 2) :foreground ,red1))))
   `(spaceline-flycheck-warning ((,class (:box (:color ,grey2 :line-width 2) :foreground ,yellow2))))
   `(spaceline-flycheck-info    ((,class (:box (:color ,grey2 :line-width 2) :foreground ,green2))))
